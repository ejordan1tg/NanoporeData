...
location = r"C:\Users\Elijah\Documents\NanoporeData\Levels_2.3.4.4extra 1me_1meMBD2.csv"
...
print(dataset)
## storing the values (everything but the attribute names) of the dataset in a variable called "array"
array = dataset.values
print('\n')
print('here are all of the contents of the dataset')
print(array)
print('\n')
values = array[:, 0:9]
